...
public static class Vector2Extensions
{
    ...
    /// <returns> The normalized Vector2 of the direction to the target. </returns>
    ...
    /// <param name="original"> This Vector2. </param>
    /// <param name="topLeftPoint"> One of the Vector2 to compare to this. </param>
    /// <param name="bottomRightPoint"> The other Vector2 to compare to this. </param>
